 ...
 */
// 登陆
export const login = (params, scb, fcb) => {
  return Ajax.get(`login/doLogin?username=` + params.username + '&password=' + params.password).then(res => commonHandleResponse(res, scb, fcb));
};
/**
 * 商户管理
 */
