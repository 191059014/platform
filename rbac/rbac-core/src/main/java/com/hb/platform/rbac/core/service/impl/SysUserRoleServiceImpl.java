...
import com.hb.platform.rbac.core.dao.dobj.SysUserRoleDO;
import com.hb.platform.rbac.core.dao.mapper.ISysUserRoleMapper;
import com.hb.platform.rbac.core.service.ISysUserRoleService;
...
public class SysUserRoleServiceImpl implements ISysUserRoleService {
    ...
    public SysUserRoleDO selectOne(SysUserRoleDO sysUserRole) {
        ...
        return CollectionUtils.isEmpty(list) ? new SysUserRoleDO() : list.get(0);
    }
