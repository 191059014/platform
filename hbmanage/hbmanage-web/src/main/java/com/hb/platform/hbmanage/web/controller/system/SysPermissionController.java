...
import com.hb.platform.hbmanage.web.model.dto.ElementuiMenu;
import com.hb.platform.hbmanage.web.model.dto.ElementuiTree;
import com.hb.platform.hbmanage.web.model.vo.response.ElementuiMenuResponse;
import com.hb.platform.hbmanage.web.model.vo.response.ElementuiTreeResponse;
...
import com.hb.platform.unic.rbac.enums.ResourceType;
...
public class SysPermissionController {
    ...
    private List<ElementuiMenu> findChildrenMenuCycle(List<SysPermissionDO> allList, List<SysPermissionDO> childList) {
        ...
        childList.forEach(access -> {
            ElementuiMenu menu = ElementuiMenu.builder().index(access.getId()).name(access.getPermissionName())
